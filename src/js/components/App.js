...
const quotes = [
  ...
  {
    quote: "I am not a failure, I am a life.",
  ...
  {
    quote: "Winning isn&rsquo;t everything, but wanting to win is.",
  ...
  {
    quote: "Life shrinks or expands in proportion to one&rsquo;s courage.",
    author: "Anais Nin",
  },
  {
    quote:
      "The most beautiful things in the world cannot be seen or even touched &mdash; they must be felt with the heart.",
    author: "Helen Keller",
  },
  {
    quote:
  ...
  {
    quote: "You miss 100% of the shots you don&rsquo;t take.",
